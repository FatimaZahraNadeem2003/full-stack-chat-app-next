...
import { Badge, Menu, MenuButton, MenuList, MenuItem, Button, Box, Text, Avatar, Flex, VStack, Icon, Collapse } from '@chakra-ui/react';
            ...
            {notification.length > 0 ? (
              [...notification].reverse().map((msg, index) => (
                <MenuItem 
                  ...
                  _hover={{ bg: 'gray.100' }}
                  onClick={() => {
                    // Handle notification click - maybe switch to the chat
                    setIsOpen(false);
                  }}
                >
